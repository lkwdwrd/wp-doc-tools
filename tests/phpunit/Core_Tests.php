<?php
namespace TenUp\WP_Documentor_Tools\Core;
...
use TenUp\WP_Documentor_Tools as Base;
...
class Core_Tests extends Base\TestCase {
	...
	public function test_i18n() {
		...
		\WP_Mock::wpFunction( 'load_textdomain', array(
			'times' => 1,
			'args' => array( 'wpd_tools', 'lang_dir/wpd_tools/wpd_tools-en_US.mo' ),
		) );
		...
		\WP_Mock::wpFunction( 'load_plugin_textdomain', array(
			'times' => 1,
			'args' => array( 'wpd_tools', false, 'path/languages/' ),
		) );
